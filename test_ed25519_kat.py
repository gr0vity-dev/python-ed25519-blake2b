...
class KnownAnswerTests(unittest.TestCase):
    def test_all(self):
        # kat-py_ed25519_blake2b-blake2b.txt has been derived from the original
        # kat-py_ed25519_blake2b.txt sample collection included with the library
        for i, line in enumerate(open("kat-ed25519-blake2b.txt")):
            ...
            vk2 = py_ed25519_blake2b.VerifyingKey(vk_s)
            ...
            # deterministic sigs
            self.failUnlessEqual(hexlify(newsig), hexlify(sig))
